    ...
    const handleCheck = async () => {
        ...
        try {
            ...
            const eligibilityData = {
                stateId: formData.state, // Sending Name as per user curl requirement
                districtId: formData.district, // Sending Name as per user curl requirement
                blockId: formData.block, // Sending Name as per user curl requirement
                SectorType: formData.sector,
                projectType: formData.projectType,
                waterRequirement: parseFloat(formData.groundWaterRequirement),
                                ...
                                <div className="form-group">
                                    ...
                                    >
                                        ...
                                        {industryTypes.map((type, idx) => {
                                            const name = type.industryName || type.name || type.label || type.type || "Unknown Type";
                                            const key = type.industryTypeId || type.id || type.code || idx;
                                            return <option key={key} value={name}>{name}</option>;
                                        })}
                                    </select>
                                </div>
